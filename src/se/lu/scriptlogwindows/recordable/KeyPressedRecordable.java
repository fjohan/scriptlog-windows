 ...
 * @author johanf
 */
public class KeyPressedRecordable extends Recordable {

    private int keyCode;

    public KeyPressedRecordable() {
    }

    ;
    
    public KeyPressedRecordable(int eventID, long when, int keyCode) {
        super(eventID, when);
        setKeyCode(keyCode);
    }
...
//        sb.append("<keyPressed>").append(KeyLogConstants.DUMP_SEPARATOR);
