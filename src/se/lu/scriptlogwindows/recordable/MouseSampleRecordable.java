 ...
 * @author johanf
 */
public class MouseSampleRecordable extends Recordable {

    private int mouseX;
    private int mouseY;

    public MouseSampleRecordable(int eventID, long when, int mouseX, int mouseY) {
        super(eventID, when);
        setMouseX(mouseX);
        setMouseY(mouseY);
    }
...
//        sb.append("<mouseSample>").append(KeyLogConstants.DUMP_SEPARATOR);
