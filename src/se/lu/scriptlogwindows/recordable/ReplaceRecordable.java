 ...
 * @author johanf
 */
public class ReplaceRecordable extends Recordable {
    ...
    public ReplaceRecordable(int eventID, long when, int offset, int length, String str) {
        super(eventID, when);
        setOffset(offset);
        setLength(length);
        setStr(str);
...
//        sb.append("<replace>").append(KeyLogConstants.DUMP_SEPARATOR);
//        sb.append(getWhen()).append(KeyLogConstants.DUMP_SEPARATOR);
//        sb.append(getOffset()).append(KeyLogConstants.DUMP_SEPARATOR).append(getLength()).append(KeyLogConstants.DUMP_SEPARATOR).append(getStr()).append(KeyLogConstants.NEW_LINE);
//        return sb.toString();
//    }
